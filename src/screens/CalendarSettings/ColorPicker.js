...
import {
    ...
    LightnessSlider, SaturationSlider
...
export class ColorPicker extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        this.setState({
            color: nextProps.color ? tinycolor(nextProps.color).toHsl() : this.state.color
        })
    }
                ...
                <View style={styles.container}>
                    <View style={styles.header}>
                        <TouchableOpacity onPress={onCancel}>
                            <Text  allowFontScaling={true}  style={styles.headerButton}>{cancelLabel}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => {
                        ...
                        >
                            <Text  allowFontScaling={true}  style={styles.headerButton}>{okLabel}</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.content}>
                        ...
                        >
                            <Text  allowFontScaling={true}  style={styles.lightText}>LIGHT TEXT</Text>
                            <Text  allowFontScaling={true}  style={styles.darkText}>DARK TEXT</Text>
                        </View>
                        {/* <View style={styles.colorString}>
                            <Text  allowFontScaling={true}  style={styles.colorStringText}>
                        ...
                        <Text  allowFontScaling={true}  style={styles.swatchesText}>{swatchesLabel}</Text>
