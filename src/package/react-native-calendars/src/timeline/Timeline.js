...
let dimensionWidth = widthResponse;
      ...
      return (
        <TouchableOpacity
          ...
          {this.props.renderEvent ? (
            ...
            <View>
              <Text allowFontScaling={true} numberOfLines={1} style={this.styles.eventTitle}>
                {event.title || 'Event'}
              </Text>
              {numberOfLines > 1 ? (
                <Text allowFontScaling={true}
              ...
              {numberOfLines > 2 ? (
                <Text allowFontScaling={true} style={this.styles.eventTimes} numberOfLines={1}>
