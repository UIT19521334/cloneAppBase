    ...
    return (
      ...
      >
        {weekDaysNames.map((day, index) => (
          <Text  allowFontScaling={true}  allowFontScaling={true} key={day+index} style={this.style.weekday} numberOfLines={1}>{day}</Text>
        ))}
      </View>
    );
  }
  ...
  renderHeader() {
    ...
    return (
      <Animated.View
        ...
        pointerEvents={'none'}
      >
        <Text  allowFontScaling={true}  allowFontScaling={true} style={this.style.headerTitle}>{monthYear}</Text>
