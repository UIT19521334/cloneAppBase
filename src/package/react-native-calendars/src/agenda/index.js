...
export default class AgendaView extends Component {
  ...
  constructor(props) {
    ...
    this.viewHeight = heightDevice;
    this.viewWidth = widthResponse;
    ...
    return (
      <View testID={this.props.testID} onLayout={this.onLayout} style={[this.props.style, { flex: 1, overflow: 'hidden' }]}>
        ...
        <Animated.View style={weekdaysStyle}>
          {this.props.showWeekNumbers && <Text allowFontScaling={true} allowFontScaling={true} style={this.styles.weekday} numberOfLines={1}></Text>}
          {weekDaysNames.map((day, index) => (
            <Text allowFontScaling={true} allowFontScaling={true} key={day + index} style={this.styles.weekday} numberOfLines={1}>{day}</Text>
          ))}
        </Animated.View>
        <Animated.ScrollView
