/**
 * @file    : ModalDropdown/index.js
 * @author  : Manh Le
 * @date    : 2021-01-26
 * @purpose : Create custom Modal Dropdown UI
*/
...
import {
    ActivityIndicator, Dimensions, FlatList, Modal, StyleSheet, Text, TouchableHighlight, TouchableNativeFeedback,
...
export default class ModalDropdown extends Component {
    ...
    _calcPosition() {
        ...
        const windowWidth = widthDevice;
        const windowHeight = heightDevice;
    ...
    _renderRow = ({ item: rowData, index: rowID, separators }) => {
        ...
        if (rowID === this.props.options?.length - 1 && this.props.initialScrollIndex) {
            setTimeout(() => {
                this.dropdownList.scrollToIndex({ animated: true, index: this.props.initialScrollIndex })
            }, 300);
        }
...
const styles = StyleSheet.create({
    ...
    dropdown: {
        position: 'absolute',
        // Add by Khiem Ha 19.03.21
        // Fix issue dropdown list item not wrap content
        height: null,
        maxHeight: (33 + StyleSheet.hairlineWidth) * 5,
        // height: (33 + StyleSheet.hairlineWidth) * 5,
        // End by Khiem Ha 19.03.21
    ...
    list: {
        //flexGrow: 1,
        paddingRight: 6 // Fix issue dropdown row item not padding right
    },
    rowText: {
        paddingHorizontal: 6,
        paddingVertical: 10,
