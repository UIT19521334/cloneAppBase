...
public class RNStringeeCall2CustomModule extends ReactContextBaseJavaModule implements StringeeCall2.StringeeCallListener {

    private Callback mCallback;
    private ArrayList<String> jsEvents = new ArrayList<String>();
    private Handler handler;

    public RNStringeeCall2CustomModule(ReactApplicationContext reactContext) {
        super(reactContext);
    }
    ...
    public void makeCall(String params, Callback callback) {
        ...
        try {
            ...
            final StringeeCall2 mStringeeCall = new StringeeCall2(StringeeManager.getInstance().getClient(), from, to);
